...
const RewardAmountDaily = () => {
    ...
    useEffect(() => {
        const fetchUserInfo = async () => {
            try {
                const response = await fetch(`${BASE_URL}/api/v1/user/rewardAmountDilyList`, {
                    method: 'POST',
                    headers: {
                ...
                console.log("RewardAmountDaily", userDataFromResponse);
...
export default RewardAmountDaily;
